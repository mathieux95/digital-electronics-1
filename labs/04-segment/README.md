...
2. Complete the decoder truth table for **common anode** 7-segment display.
   ...
   > ![https://lastminuteengineers.com/seven-segment-arduino-tutorial/](https://github.com/mathieux95/digital-electronics-1/blob/main/labs/04-segment/images/7-Segment-Display-Number-Formation-Segment-Contol.png)
   >
...
1. Perform the following steps to implement the seven-segment display decoder on the Nexys A7 board.
   ...
   3. Use [direct instantiation](https://github.com/tomas-fryza/digital-electronics-1/wiki/Direct-instantiation) and define an architecture of the top level.
        ...
        ![Top level](https://github.com/mathieux95/digital-electronics-1/blob/main/labs/04-segment/images/top_schema_hex_7seg_3.png)
